...
define ('V_URL', '#^((https?|ftp):\/\/)?(www.)?([0-9a-zабвгдеёжзийклмнопрстуфхцчшщъыьэюя]+(-?[0-9a-zабвгдеёжзийклмнопрстуфхцчшщъыьэюя]+)*\.)+[a-zабвгдеёжзийклмнопрстуфхцчшщъыьэюя]{2,6}(\/[-0-9A-Za-zАаБбВвГгДдЕеЁёЖжЗзИиЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщЪъЫыЬьЭэЮюЯя=_.%\?&\/]*)*$#i');
