...
$settingsInfo = array(
	...
	'new_pm_mail' => array(
		'type' => 'select',
		'title' => 'Уведомлять о новых личных сообщениях по e-mail',
		'description' => 'Не рекомендуется использовать при большом числе пользователей (возможно внесение в спам-листы).',
		'options' => array(
			'1' => 'Разрешено',
			'0' => 'Запрещено',
		),
    ...
    'pm_type' => array(
        'type' => 'select',
        'title' => 'Вид работы с личными сообщениями',
        'description' => 'Не рекомендуется использовать при большом числе пользователей (возможно внесение в спам-листы).',
        'options' => array(
            '0' => 'Список всех сообщений (классическая компоновка)',
            '1' => 'Группировка по собеседникам',
        ),
    ),
    'active' => array(
        'type' => 'checkbox',
