...
Любые жалобы и предложения оставляйте пожалуйста на официальном сайте.
Сделаем нашу жизнь в интернете светлее вместе.

Помощь в развитии проекта
Если вам понравился наш проект и вы хотите каким либо образом поддержать его, вы можете сделать это любым удобным для вас способом. 
Это может быть как "спасибо", так и материальная поддержка (кошельки смотреть тут http://fapos.net).
Так же вы можете разместить на своем сайте ссылку на наш проект или нашу кнопку.
Ну а если вы обладаете знаниями в веб разработке, то можете создавать плагины или шаблоны для Fapos CMS.
Также просим помочь нам с переводом FaposCMS на другие языки.
Мы будем благодарны за любую помощь. Спасибо.

Перевести FaposCMS на другие языки можно на нашей странице на transifex:
https://www.transifex.com/projects/p/faposcms/
...
2. Установите права 0777 на следующие папки
	...
	/templates/*
	/sitemap.xml
3. Перейдите на сайт и проведите установку.
